...
// Store and hooks
import { useEnrollmentsData, useCourseProgressData } from "@/lib/hooks/use-dashboard-store"
...
export default function CourseViewer() {
  ...
  // Dashboard store hooks - use individual selectors to prevent infinite loops
  const { enrollments = [], loadUserEnrollments } = useEnrollmentsData()
  const { 
    courseProgress = {}, 
    lessonProgress = {},
  ...
  useEffect(() => {
    ...
    loadData()
  }, [user?.id, loadUserEnrollments, loadUserProgress, enrollments.length])
