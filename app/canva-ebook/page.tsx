  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col bg-[#f9f6f2]">
        ...
        {/* Footer (Consistent with P2P page) */}
         <footer className="w-full border-t border-[#e7d9ce] bg-[#f9f6f2]">
           <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:flex-row lg:gap-12">
             ...
             <div className="grid flex-1 grid-cols-2 gap-8 sm:grid-cols-3">
                {/* Quick Links, Resources, Legal columns */}
                <div className="space-y-4">
                  <h4 className="text-sm font-medium text-[#5d4037]">Quick Links</h4>
                  <ul className="space-y-2">
                    {[ { name: "Home", href: "/"}, { name: "Papers to Profits", href: "/papers-to-profits" }, { name: "Shop", href: "#" }, { name: "Login", href: "#" }].map((item) => (
                      <li key={item.name}><Link href={item.href} className="text-sm text-[#6d4c41] hover:text-brand-purple transition-colors">{item.name}</Link></li>
                    ))}
                  </ul>
                </div>
                 <div className="space-y-4">
                  <h4 className="text-sm font-medium text-[#5d4037]">Legal</h4>
                   <ul className="space-y-2">
                      {[ { name: "Terms", href: "#"}, { name: "Privacy", href: "#" } ].map((item) => (
                        <li key={item.name}><Link href={item.href} className="text-sm text-[#6d4c41] hover:text-brand-purple transition-colors">{item.name}</Link></li>
                      ))}
                    </ul>
                 </div>
