        ...
        >
          ...
          >
            <blockquote className="space-y-2">
              <p className="text-lg">
                "Joining Graceful Homeschooling was one of the best decisions for our family's
                educational journey. The resources are thoughtfully created and truly helpful."
              </p>
              <footer className="text-sm">Emily Thompson</footer>
            </blockquote>
          </motion.div>
        </motion.div>
          ...
          <div className="mx-auto w-full max-w-sm space-y-6">
            <motion.div variants={fadeIn} className="flex flex-col space-y-2 text-center">
              ...
              <p className="text-sm text-[#6d4c41]">
                Join our community of homeschooling families
              </p>
              <motion.div 
