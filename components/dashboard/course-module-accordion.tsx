...
export function CourseModuleAccordion({
  ...
  const calculateModuleProgress = (moduleId: string, lessons: any[]) => {
    ...
    // Use a more strict definition of completed lessons
                ...
                >
                  <div className="divide-y">
                    {sortedLessons.map(lesson => {
                      ...
                      // Only consider a lesson complete if status is explicitly 'completed'
                      // This is the most reliable way to determine completion
